                            ...
                            @foreach($appointment as $a)
                               <tr>
                                   ...
                                   <td>
                                       @if($a->status ==0)
                                           <div class=" ">
                                               <a href="{{url('/edit-appointment/'.$a->id)}}" class="btn btn-primary"><i class="ti-pencil-alt"></i> Edit &nbsp;&nbsp; </a></div>
											    <div class=" " style="margin-top:10px;">
                                               <a href="javascript:void(0)" onclick="$(this).confirmDelete('{{url('/delete-appointment/'.$a->id)}}')" class="btn btn-danger"><i class="fa fa-trash-o"></i>Delete</a>
                                           </div>
                                       @endif
                                   </td>
                               </tr>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#scheduleReportForm").on('submit',function (e) {
               ...
               window.location.replace('{{url('/schedule-report')}}/schedule='+scheduleId+'/start='+start+'/end='+end);
