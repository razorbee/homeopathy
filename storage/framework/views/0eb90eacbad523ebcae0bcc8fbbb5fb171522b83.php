...
<?php endif; ?></span> | age-<?php echo e($patient->age()); ?>
                        ...
                        <div class="form-group-custom1">
                                ...
                                <select class="form-control js-select2" id="selectDisease" multiple="multiple">
                                    ...
                                    <?php $__currentLoopData = $diseases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $diseases): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($diseases -> disease); ?>" data-badge=""><?php echo e($diseases -> disease); ?></span>
                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
