<div class="tab-pane" id="application-setup">
    ...
    <form action="javascript:void(0)" id="appSetupForm">
        ...
        <div class="form-group-custom">
            <input type="text" name="app_name" value="<?php echo e(config('app.name')); ?>" required="required"/>
            <label class="control-label">Application Name</label><i class="bar"></i>
        </div>
        <div class="form-group-custom">
            <input type="text" name="timezone" value="<?php echo e(config('app.timezone')); ?>" required="required"/>
