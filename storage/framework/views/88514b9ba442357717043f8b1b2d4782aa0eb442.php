    ...
    <div class="row">
        <div class="col-md-6 col-lg-6 col-xl-6">
            <div class="widget-panel widget-style-2 bg-white">
                ...
                <h2 class="m-0 text-dark counter font-600">
                   <?php echo e(count(\App\Model\PatientAppointment::where('user_id',auth()->user()->id)->where('created_at',\Carbon\Carbon::today())->get())); ?>
        ...
        <div class="col-md-6 col-lg-6 col-xl-6">
            <div class="widget-panel widget-style-2 bg-white">
                ...
                <h2 class="m-0 text-dark counter font-600">
                    <?php echo e(count(\App\Model\PatientAppointment::where('user_id',auth()->user()->id)->get())); ?>
