<script>
    $(document).ready(function () {
        ...
        $("#durationTable").dataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo e(url('/api/data-table/all-drug-duration')); ?>",
            "columns": [
                { "data" : "#"},
                { "data": "duration" },
                { "data": "status" },
        ...
        $('#newDrugDurationForm').on('submit',function (e) {
            ...
            $.ajax({
                url: '<?php echo e(url('/save-drug-duration')); ?>',
                type: 'POST',
                data: data,
                contentType: false,
                cache: false,
        ...
        $("#updateDrugDurationForm").on('submit',function (e) {
            ...
            var data = new FormData(this);
            $.ajax({
                url: '<?php echo e(url('/update-drug-duration')); ?>'+'/'+updateDrugDurationId,
                type: 'POST',
                data: data,
                contentType: false,
                cache: false,
        ...
        <?php if(session('delete_drug_duration')): ?>
