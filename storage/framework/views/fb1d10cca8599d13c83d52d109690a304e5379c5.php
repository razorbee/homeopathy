        ...
        <div class="card-box form-zoom-in-up <?php echo e($errors->has('email') || $errors->has('password') ? 'form-shake' : ''); ?>">
            ...
            <br/>
                <form class="form-horizontal m-t-20" action="<?php echo e(route('login')); ?>" method="POST">
                    ...
                    <div class="form-group-custom<?php echo e($errors->has('username')||$errors->has('email') ? 'has-error':''); ?>">
                        <input type="text" id="user-name" name="username" value="<?php echo e(old('username')); ?>" />
                    ...
                    <div class="form-group-custom<?php echo e($errors->has('password') ? 'has-error':''); ?>">
