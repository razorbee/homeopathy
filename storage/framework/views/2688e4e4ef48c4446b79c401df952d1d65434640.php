        ...
        <div class="card-box form-zoom-in-up <?php echo e($errors->has('email') || $errors->has('password') ? 'form-shake' : ''); ?>">
            ...
            <br/>
                <form class="form-horizontal m-t-20" action="<?php echo e(route('login')); ?>" method="POST">
                    ...
                    <input type="text" id="user-name" name="name" value="<?php echo e(old('name')); ?>"/>
                    <label class="control-label" for="user-name">Name</label><i class="bar"></i>
                    ...
                    <!-- <div class="form-group-custom">
                        <input type="email" id="user-name" name="email" value="<?php echo e(old('email')); ?>" />
                        <label class="control-label" for="user-name">Email Address</label><i class="bar"></i>
                        <?php if($errors->has('email')): ?>
                            <span class="help-block">
                                <strong class="text-danger"><?php echo e($user->email); ?></strong>
                            </span>
                        <?php endif; ?>
                    </div>-->
