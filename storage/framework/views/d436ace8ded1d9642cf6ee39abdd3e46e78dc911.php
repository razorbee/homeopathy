<script>
    $(document).ready(function () {
        ...
        $("#doseTable").dataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo e(url('/api/data-table/all-drug-dose')); ?>",
            "columns": [
                { "data" : "#"},
                { "data": "dose" },
                { "data": "status" },
        ...
        $("#addDrugDoseForm").on('submit',function (e) {
            ...
            $.ajax({
                url: '<?php echo e(url('/save-drug-dose')); ?>',
                type: 'POST',
                data: data,
                contentType: false,
                cache: false,
...
//                console.log(data);
        ...
        $("#updateDrugDoseForm").on('submit',function (e) {
            ...
            var data = new FormData(this);
            $.ajax({
                url: '<?php echo e(url('/update-drug-dose')); ?>'+'/'+updateDrugDose,
                type: 'POST',
                data: data,
                contentType: false,
                cache: false,
        ...
        <?php if(session('drug_dose_delete')): ?>
