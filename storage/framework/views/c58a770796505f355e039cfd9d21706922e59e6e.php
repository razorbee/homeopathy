<script>
    $(document).ready(function () {
        ...
        $("#drugAdviceTable").dataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo e(url('/api/data-table/all-drug-advice')); ?>",
            "columns": [
                { "data" : "#"},
                { "data": "drug_advice" },
                { "data": "status" },
        ...
        $("#addDrugAdviceForm").on('submit',function (e) {
            ...
            $.ajax({
                url: '<?php echo e(url('/save-drug-advice')); ?>',
                type: 'POST',
                data: data,
                contentType: false,
                cache: false,
        ...
        $("#updateDrugAdviceForm").on('submit',function (e) {
            ...
            var data = new FormData(this);
            $.ajax({
                url: '<?php echo e(url('/update-drug-advice')); ?>'+'/'+updateDrugAdvice,
                type: 'POST',
                data: data,
                contentType: false,
                cache: false,
        ...
        <?php if(session('delete_drug_advice')): ?>
