<script>
    $(document).ready(function () {
        ...
        $("#strengthTable").dataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "<?php echo e(url('/api/data-table/all-drug-strength')); ?>",
            "columns": [
                { "data" : "#"},
                { "data": "strength" },
                { "data": "status" },
        ...
        $('#saveDrugStrength').on('submit',function (e) {
            ...
            $.ajax({
                url: '<?php echo e(url('/save-drug-strength')); ?>',
                type: 'POST',
                data: data,
                contentType: false,
                cache: false,
        ...
        $("#updateDrugStrength").on('submit',function (e) {
            ...
            var data = new FormData(this);
            $.ajax({
                url: '<?php echo e(url('/update-drug-strength')); ?>/'+updateStrengthId,
                type: 'POST',
                data: data,
                contentType: false,
                cache: false,
        ...
        <?php if(session('delete_strength')): ?>
