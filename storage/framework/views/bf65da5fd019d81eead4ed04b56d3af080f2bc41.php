...
<head>
    ...
    <link href="<?php echo e(url('/dashboard/css/style.css')); ?>" rel="stylesheet" type="text/css" />
...
<div class="wrapper-page">
    <div class="ex-page-content text-center">
        ...
        <br>
        <a class="btn btn-success waves-effect waves-light" href="<?php echo e(url('/home')); ?>"> Back to Home</a>
    </div>
</div>
</body>
</html>