    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-content">
                <h4 class="card-title">Edit assistant - <?php echo e($user->name); ?></h4>
                <form action="#" method="post" id="newAssistant" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-4" style="padding-left: 81px;">
                            <div id="image-preview"><img src="<?php echo e(url('/')); ?>/<?php echo e($user->image); ?>"  alt="">
                        ...
                        <div class="col-md-8">
							...
							<div class="form-group-custom">
                                        <select name="role" id="" required="required">
                                            <option <?php echo e($user->role ==2 ? 'selected' : ''); ?> value="2">Assistant</option>
