                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <option  value="Other">Other</option>
                                ...
                                <div class="col-md-6">
                                    <div   class="form-group-custom">
                                      <label class="control-label" id="frequencies">frequencies</label>
                                      <br>
                                      <label class="checkbox-inline" for="morning">
                                      <input type="checkbox" name="frequencies" value="morning"/>Morning
                                        </label>
                                          <label class="checkbox-inline" for="afternoon">
