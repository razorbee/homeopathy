...
<?php $__env->startSection('content'); ?>
			 ...
			 <a href="<?php echo e(url('/edit-patient/'.$patient->id)); ?>" class="pull-right btn btn-success"><i class="ti-pencil-alt"></i>Edit</a>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <?php if(auth()->user()->role == 1 || auth()->user()->role == 3): ?><a style="font-size: 15px;" href="<?php echo e(url('take-patient-to-prescription-page/'.$patient->id)); ?>" class="pull-right btn btn-success"> <i class="ti ti-ink-pen"></i> Write new prescription</a>
                        <?php endif; ?></h4>
                        <ul class="list-group">
  ...
  <?php $__currentLoopData = $patient->appointment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appoint): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								...
								<table>
								<tr>
								<td class="m-r-10" style="padding-right:40px;"> <?php echo e($patient->name); ?></td> 
                              <td  class="m-r-10" style="padding-right:40px;padding-left:40px;"> <?php echo e($appoint->date->format('d-M-Y')); ?></td>
                             <td  class="m-r-10 m-r-10" style="padding-right:40px;text-align:center;"> <?php echo e($appoint->time); ?></td>
