    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-content">
                <a href="<?php echo e(url('/new-schedule')); ?>" class="btn btn-success pull-right">New Schedule</a>
    ...
    <script>
        $(document).ready( function () {
            $('#datatable').DataTable({
                "processing": true,
                "serverSide": true,
                "ajax": "<?php echo e(url('/api/data-table/my-schedule')); ?>",
                "columns": [
                    { "data": "#"},
                    { "data": "name" },
                    { "data": "address" },
