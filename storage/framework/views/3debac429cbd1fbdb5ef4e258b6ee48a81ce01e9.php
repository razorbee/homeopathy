...
<div id="wrapper">
    ...
    <?php if (\Illuminate\Support\Facades\Blade::check('doctorother')): ?>
            <?php echo $__env->make('assets.sidebar.doctorother', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php endif; ?>
        <?php if (\Illuminate\Support\Facades\Blade::check('pharma')): ?>
            <?php echo $__env->make('assets.sidebar.pharma', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php endif; ?>
