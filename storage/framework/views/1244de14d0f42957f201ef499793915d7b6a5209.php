...
<!--
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="<?php echo e(url('/new-assistant')); ?>">New User</a></li>
                        <li><a href="<?php echo e(url('/all-assistant')); ?>">All User</a></li>
                    </ul>
                </li>
...
-->
                ...
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="<?php echo e(url('/new-drug')); ?>">Add new drug & Disease</a></li>
